...
const Pill = ({ label, onClear }: PillProps) => {
  ...
  return (
    <li className="flex w-fit justify-between gap-2 rounded-full bg-secondary pl-2 text-primaryText">
      <label
        className="py-2"
      ...
      <button
        id={buttonId}
        className="h-full rounded-r-full bg-primary pr-3 text-primaryText"
